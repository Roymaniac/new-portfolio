...
function Profile() {
  return (
    <section className="mx-auto text-white body-font overflow-hidden">
      <motion.div 
        className="container px-5 py-24 flex mx-auto flex-wrap items-center"
      ...
      >
        ...
        <motion.div 
          className="lg:w-2/6 md:w-1/2 w-full max-w-md overflow-hidden flex flex-col md:ml-auto bg-white rounded-lg shadow-lg dark:bg-black mt-10 md:mt-0"
          variants={fadeIn("left", "spring", 0.4, 1)}
        >
          <div
            className="relative overflow-hidden rounded-t-lg shadow-lg cursor-pointer group"
          >
            <img 
              src={myPic} 
              alt='avatar' 
            ...
            />
            <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black to-transparent p-4 opacity-100">
          ...
          <div className="px-6 py-4">
            <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200 hover:text-red-600 transition-colors duration-300">
              <svg
